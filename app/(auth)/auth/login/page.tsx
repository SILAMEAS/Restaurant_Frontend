...
export default function LoginPage() {
    ...
    return (
        <div
            className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 flex items-center justify-center p-4 sm:p-8">
            <Link
                href="/"
            ...
            <Card
                className="w-full max-w-md bg-black/30 backdrop-blur-xl border border-gray-800 shadow-2xl transition-all duration-300 hover:shadow-primary/10">
                <CardHeader className="space-y-2">
                    <CardTitle
                        className="text-3xl font-bold bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent">Login</CardTitle>
                    <CardDescription className="text-gray-400">Enter your credentials to access your
